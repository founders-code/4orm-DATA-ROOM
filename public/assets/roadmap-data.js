const DATA = {
  ...
  wins: [
    ...
    { date:"2026-06-07", vertical:"product",   text:"Expansion revenue surface mapped: eleven tokenizable asset classes the exchange is built to list (stablecoins, sovereign and sub-sovereign debt, gold and commodities, real estate, private credit, carbon, infrastructure, equities, AI-linked, education), each with sourced market sizing and fee mechanics." },
    ...
    { date:"2026-06-03", vertical:"capital",   text:"Pre-seed round set at $3M, opening July 1, 2026." },
    ...
    { date:"2026-04-24", vertical:"product",   text:"ClickUp + Google Drive rebuilt to scale for a 66-person org, with AI agents deployed across operations." },
  ...
  verticals: [
    /* 1 ---------------------------------------------------------- */
    {
      ...
      checkpoints:[
        ...
        {state:"done", t:"Four high-end websites deployed", d:"KCS, 4orm Finance, 4ormEx, and the demo exchange — built in-house with AI for a few hundred dollars of credits."},
        {state:"done", t:"Ops backend rebuilt to scale", d:"ClickUp + Google Drive restructured for a 66-person org with AI document routing; CRM, Sales Navigator, ZoomInfo deployed."},
    ...
    /* 3 ---------------------------------------------------------- */
    {
      ...
      checkpoints:[
        ...
        {state:"todo", t:"Formally open the $3M pre-seed round", d:"Opens July 1, 2026, once docs + EBC land."},
      ...
      facts:[
        "Target: <b>$3M</b> · Opens July 1, 2026",
        "Valuation: <b>$10M</b>",
